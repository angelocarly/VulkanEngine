...
public:
    ...
    bool isDeviceSuitable(VkSurfaceKHR surface) {
        VulkanDevice::QueueFamilyIndices indices = findQueueFamilies(surface);
    ...
    void createLogicalDevice(VkSurfaceKHR surface, VkQueue *graphicsQueue, VkQueue *presentQueue)
    {
