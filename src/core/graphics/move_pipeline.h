...
#ifndef _MOVE_PIPELINE_H_
#define _MOVE_PIPELINE_H_

#include <vks/vks_util.h>
#include "render_pipeline.h"
#include <lodepng.h>

class MovePipeline : public IRenderPipeline
{
 public:
	MovePipeline(VksDevice& device, VksSwapChain& swapChain, VkDescriptorPool& descriptorPool)
...
//		pipeline = std::make_unique<VksPipeline>(_device, _swapChain, pipelineConfigInfo);
		...
		shaderStageCreateInfo.module = _device.createShaderModule(VksUtil::readFile("shaders/move.comp.spv"));
